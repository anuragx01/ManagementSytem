...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        return RedisCacheManager.builder(connectionFactory)
                ...
                .withCacheConfiguration("departments", defaultConfig.entryTtl(Duration.ofHours(1)))
                .withCacheConfiguration("employees", defaultConfig.entryTtl(Duration.ofMinutes(15)))
                .build();
    }
