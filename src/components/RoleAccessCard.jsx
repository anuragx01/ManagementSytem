    ...
    <Card className="p-5">
      <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-start">
        <div>
          ...
          <h2 className="mt-2 text-xl font-extrabold text-ink-primary">{activeRole.title}</h2>
          <p className="mt-2 text-sm text-ink-secondary">This is static frontend permission logic for UI preview.</p>
        </div>
